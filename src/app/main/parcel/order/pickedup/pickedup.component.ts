...
@Component({
  ...
  templateUrl: './pickedup.component.html',
  styleUrls: ['./pickedup.component.scss']
})
export class PickedupComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.order.getOrdersByType('pickedUp').subscribe((result) => {
