...
@Component({
  selector: 'app-reacheddelivery',
  templateUrl: './reacheddelivery.component.html',
  styleUrls: ['./reacheddelivery.component.scss']
})
export class ReacheddeliveryComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.order.getOrdersByType('reachedDelivery').subscribe((result) => {
