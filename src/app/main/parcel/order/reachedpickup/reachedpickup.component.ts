...
@Component({
  selector: 'app-reachedpickup',
  templateUrl: './reachedpickup.component.html',
  styleUrls: ['./reachedpickup.component.scss']
})
export class ReachedpickupComponent implements OnInit {
