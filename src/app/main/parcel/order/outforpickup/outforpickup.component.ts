...
@Component({
  selector: 'app-outforpickup',
  templateUrl: './outforpickup.component.html',
  styleUrls: ['./outforpickup.component.scss']
})
export class OutforpickupComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.order.getOrdersByType('outForPickup').subscribe((result) => {
